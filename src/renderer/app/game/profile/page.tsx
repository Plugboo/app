    ...
    >
      {profile && (
        <div className="flex flex-col gap-5">
          <ProfileSettingsModal open={settingsModalOpen} onChangeOpen={setSettingsModalOpen} profile={profile} />
          <div className="flex justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button className="!px-2" rounded="full" type="secondary" onClick={() => setSettingsModalOpen(true)}>
                <Settings />
              </Button>
            </div>
          </div>
