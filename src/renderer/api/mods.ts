import { Comment, GetCommentsOptions, Mod } from '@common/service'
...
export async function searchMods(gameId: string, query?: string): Promise<Mod[]> {
  return await window.electron.ipc.invoke('mods::search', gameId, query) as Mod[]
}