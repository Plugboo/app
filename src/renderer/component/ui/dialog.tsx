...
export function Dialog(props: DialogProps)
{
    return (
        <BaseDialog.Root open={props.open} onOpenChange={props.setOpen}>
            <BaseDialog.Portal>
                <BaseDialog.Backdrop className="fixed inset-0 min-h-dvh bg-black opacity-50 data-ending-style:opacity-0 data-starting-style:opacity-0 supports-[-webkit-touch-callout:none]:absolute" />
